      ...
      null,
      {
        ...
        _c_pre: function(condition) {
          if (has("ppwcode-contracts-precondition") && !condition.apply(this)) {
            throw new _PreconditionViolationError(this, this._c_pre.caller,
                                                  this._c_pre.caller.caller,
                                                  this._c_pre.caller.arguments, condition);
          }
        },
        ...
        _c_prop_string: function(subject, propName) {
          ...
          if (exists) {
            var value = s[pName];
            return value === null || value === undefined || lang.isString(value);
          }
          else {
            return false;
          }
        ...
        _c_prop_date: function(subject, propName) {
          ...
          if (exists) {
            var value = s[pName];
            return value === null || value === undefined || js.typeOf(value) === "date";
          }
          else {
            return false;
          }
        ...
        _c_prop_function: function(subject, propName) {
          ...
          if (exists) {
            var value = s[pName];
            return value === null || value === undefined || lang.isFunction(value);
          }
          else {
            return false;
          }
